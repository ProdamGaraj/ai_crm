    ...
    <Stack spacing={3}>
      ...
      <Paper sx={{ p: 2 }}>
        ...
        <Grid container spacing={2} alignItems="center">
          {/* УБРАН 'item' prop */}
          <Grid xs={12} sm={6} md={3}><TextField label="Поиск по ФИО" fullWidth size="small" {...register('full_name')} /></Grid>
          <Grid xs={12} sm={6} md={3}><TextField label="Поиск по телефону" fullWidth size="small" {...register('phone_number')} /></Grid>
          <Grid xs={12} sm={6} md={3}><TextField label="Поиск по Email" fullWidth size="small" {...register('email')} /></Grid>
          ...
          <Grid xs={12} sm={6} md={3}><TextField label="ИНН" fullWidth size="small" {...register('inn')} /></Grid>
          <Grid xs={12} sm={6} md={3}><TextField label="ПИНФЛ" fullWidth size="small" {...register('pinfl')} /></Grid>
          <Grid xs={6} sm={3} md={3}>
