...
import {
    ...
    Avatar, IconButton, Card, CardMedia, CardActions, Alert
} from '@mui/material';
...
export default function ProjectDetailPage() {
  ...
  return (
    <Paper>
      <Stack direction="row" spacing={2} sx={{ p: 3, pb: 1 }} alignItems="center">
        ...
        <form onSubmit={handleSubmit(onUpdateSubmit)}>
          <Stack spacing={3}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}><Typography variant="h6">УТП</Typography></Grid>
              ...
              <Grid item xs={12}><Typography variant="h6">Юридическая информация</Typography></Grid>
